...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-if7e0bu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-if7e0bu.containers.anotherwebservice.com/
...
```
git clone git@github.com:SandyYPradhana/container-if7e0bu.git
cd container-if7e0bu
```
...
```
docker attach container-if7e0bu
```
